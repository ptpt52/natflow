...
#define NF_FF_IFNAME_FILTER_BIT 7
#define NF_FF_IFNAME_FILTER (1 << NF_FF_IFNAME_FILTER_BIT)
...
#define NF_FF_ORIGINAL_RELEARN_BIT 21
#define NF_FF_ORIGINAL_RELEARN (1 << NF_FF_ORIGINAL_RELEARN_BIT)
#define NF_FF_REPLY_RELEARN_BIT 22
#define NF_FF_REPLY_RELEARN (1 << NF_FF_REPLY_RELEARN_BIT)
