...
#define NATFLOW_DPI_CATALOG_REVISION 3U
...
enum natflow_dpi_app_id {
	...
	NATFLOW_DPI_APP_NTP = 19,
	NATFLOW_DPI_APP_SNMP = 20,
	NATFLOW_DPI_APP_RADIUS = 21,
	NATFLOW_DPI_APP_TFTP = 22,
	NATFLOW_DPI_APP_LDAP = 23,
	NATFLOW_DPI_APP_NFS = 24,
	NATFLOW_DPI_APP_SOCKS = 25,
	NATFLOW_DPI_APP_COAP = 26,
