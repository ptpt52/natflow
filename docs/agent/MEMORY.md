...
- 2026-08-16 DPI 固定 catalog revision=2，共 27 项：18 个协议以及 YouTube=`0x1001`、Netflix=`0x1002`、爱奇艺=`0x1003`、Telegram=`0x2001`、微信=`0x2002`、QQ=`0x2003`、钉钉=`0x2004`、淘宝=`0x4001`、TikTok=`0x5001`。48 项 exact/label-boundary suffix 域名来自既有表和本地 nDPI；不采用 `wx.`/`weixin.` 宽泛 substring，共享 CDN 只登记完整 exact hostname。DNS QNAME 仍只累计 `dns_app_intents`，不写目标 App。
