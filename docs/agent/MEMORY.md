...
| `natflow_l7.c/.h` | L7 hook 生命周期骨架和共享 feature core；当前负责集中触发 legacy URL hook 注册/注销，提供 packet view、host/URI normalize 和 feature 结构，HTTP/TLS/QUIC 解析仍在迁移中。 |
